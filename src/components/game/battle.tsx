...
export function BattleView() {
  ...
  return (
    <div className="flex h-full flex-col">
      {/* ── Vertical scroll region only ── */}
      <div className="min-h-0 flex-1 overflow-y-auto px-4 pt-3 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        ...
        <div className="mt-3 flex flex-col gap-3">
          ...
          <ol className="space-y-1 pb-4 font-mono text-[11px] leading-relaxed text-muted">
      ...
      {/* ── Fixed bottom: team strip + catch/heal (no vertical scroll parent) ── */}
      <div className="shrink-0 border-t border-border bg-bg px-4 pb-3 pt-2">
        <div className="flex flex-nowrap gap-1.5 overflow-x-auto pb-2 [-webkit-overflow-scrolling:touch] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {team.map((p, i) => {
